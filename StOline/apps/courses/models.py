...
class Course(models.Model):
    ...
    detail = UEditorField(verbose_name=u'课程详情',width=600, height=300, imagePath="courses/ueditor/", filePath="courses/ueditor/"
                                         , default='') #TextField不限制字段长度
    is_banner = models.BooleanField(default=False, verbose_name=u'是否轮播')
    degree = models.CharField(choices=(("cj","初级"),("zj","中级"),("gj","高级")),max_length=2)
    learntime = models.IntegerField(default=0, verbose_name=u"学习时长(分钟数)")
    ...
    teacher_tell = models.CharField(default="", max_length=300, verbose_name=u"学到什么")
...
class Lesson(models.Model):
    course = models.ForeignKey(Course, verbose_name=u"课程") #ForeignKey django的外键
